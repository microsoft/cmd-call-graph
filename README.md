...
![call graph](https://github.com/Microsoft/cmd-call-graph/raw/main/examples/example1-nodestats.png)

If the `--hide-node-stats` option is enabled, then the following graph would be generated:

![call graph showall](https://github.com/Microsoft/cmd-call-graph/raw/main/examples/example1.png)
